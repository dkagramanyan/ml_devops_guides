...
Для запуска нужно сконфигурировать конфиг выше и запустить сервер командой
```
nohup jupyter lab &
```

Для поиска созданного процесса нужно ввести команду ниже. Выведется список задач nohup с их PID
```
jobs -l
```
